...
This project implements a Texas Hold’em AI based on the **Single Deep Counterfactual Regret Minimization** algorithm. It is based on Eric Steinberger’s paper _Single Deep Counterfactual Regret Minimization_ and features an expanded action space.
